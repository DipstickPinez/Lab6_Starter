...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		let elementSty = document.createElement('style');
		...
		* {
		...
		this.shadowEl.append(elementSty);
		this.shadowEl.append(elementArt);
	}
	...
	set data(data) {
		...
		const selectedArticle = this.shadowEl.querySelector('article');
